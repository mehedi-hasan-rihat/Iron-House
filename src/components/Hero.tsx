...
/* ─── masked word reveal from bottom ─── */
function Word({
  children,
  delay = 0,
  className = "",
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ── colour grades ── */}
      {/* deep bottom shadow so stats always read */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "linear-gradient(to top,  #050505 0%, #05050590 20%, transparent 48%)," +
            "linear-gradient(to right, #050505 0%, #05050580 30%, transparent 60%)," +
            "linear-gradient(to bottom, #05050555 0%, transparent 22%)",
        }}
      />
      ...
      <div className="absolute inset-0 flex flex-col justify-end md:justify-center px-6 pb-32 md:pb-0 md:px-16 max-w-4xl">
        ...
        >
          {ready && (
            <>
              ...
              <div>
                <Word delay={0.64} className="text-[#c8a96e]">
                  DHAKA
                </Word>
              </div>
            </>
      ...
      <motion.div
        className="absolute bottom-0 left-0 right-0 border-t border-[#1a1a1a] bg-[#050505]/60 backdrop-blur-sm"
      ...
      >
        <div className="mx-auto flex max-w-[1600px] items-stretch divide-x divide-[#1a1a1a] px-6 md:px-16">
          ...
          {/* coordinates + scroll cue — right-most */}

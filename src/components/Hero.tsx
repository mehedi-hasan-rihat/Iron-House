        ...
        <AnimatePresence mode="sync">
          ...
          {act === 1 && (
            ...
            >
              ...
              <div className="absolute inset-0" style={{ background: "linear-gradient(to top, #050505 0%, rgba(5,5,5,0.6) 32%, transparent 62%)" }} />
              <div className="absolute inset-0 md:hidden" style={{ background: "rgba(5,5,5,0.35)" }} />
              <div className="absolute inset-0 hidden md:block" style={{ background: "linear-gradient(to right, rgba(5,5,5,0.25) 0%, transparent 50%)" }} />
            </motion.div>
          )}
        ...
        <AnimatePresence mode="sync">
            ...
            >
              ...
              <div className="md:hidden absolute inset-x-0 bottom-0 px-6 pb-20 space-y-5">
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <span className="label" style={{ color: ACC }}>01</span>
                ...
                <motion.div
                  initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2, duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
                  className="pt-5" style={{ borderTop: `1px solid rgba(255,255,255,0.08)` }}
                >
                  <div className="flex items-center gap-3 mb-3">
                    <span className="label" style={{ color: ACC }}>02</span>
                    <span className="h-px flex-1 bg-white/10" />
              ...
              >
                <p className="font-display leading-none select-none mb-1"
                  style={{ fontSize: "clamp(4rem, 7vw, 8rem)", letterSpacing: "-0.04em", color: `${ACC}18` }}>01</p>
              ...
              >
                <p className="font-display leading-none select-none mb-1"
                  style={{ fontSize: "clamp(4rem, 7vw, 8rem)", letterSpacing: "-0.04em", color: `${ACC}18` }}>02</p>
                <div className="pt-5" style={{ borderTop: `1px solid ${ACC}33` }}>
          ...
          {act === 2 && (
            ...
            >
              ...
              <motion.div className="absolute top-28 left-6 md:left-16 hidden md:block"
              ...
              {/* mobile eyebrow */}
              <motion.div className="absolute top-24 left-6 md:hidden"
                initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                transition={{ delay: 0.1, duration: 0.5 }}>
                <p className="label tracking-[0.4em]" style={{ color: ACC }}>Strength Floor · Since 2016</p>
              </motion.div>
